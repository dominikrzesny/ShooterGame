...
/** klasa Kolko, ktora odpowiada za naliczenie dodatkowych punktow albo amunicji,
 *  w zaleznisci od losowania. Zachowuje sie jako objekt dziedziciacy po klasie Przeciwnik.
 */
public class Kolko extends Przeciwnik {

    int promien;


    Kolko(AnchorPane planszaGry, Label tablicaWyniku, Label tablicaPrzeciwnikow,Label tablicaAmunicji, float szer){
    ...
    /**
     * {@link #paint()} Funkcja odpowiadajaca za rysowanie objektu Kolko.
    ...
    public void paint(){
        ...
        Circle kolko = new Circle(x,y,szerokosc/2);
